public class ChessBoard {
    ...
    public boolean castling0() { //длинная рокировка (гуглите что такое длинная рокировка)
    ...
    public boolean castling7() { //короткая рокировка (гуглите что такое короткая рокировка)
        if (nowPlayer.equals("White")) {
